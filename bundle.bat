...
rem   + Run-Tracker.bat / Setup.bat / README.txt (from packaging\) + version.txt
rem "Extract here" then double-click Run-Tracker.bat (first run self-installs Node
rem and the npm packages). Pass the release tag as the first arg, e.g.
rem   bundle.bat v2.0.0
rem The tag is written to version.txt, which Run-Tracker.bat exports as H3_VERSION
...
rem Layout: root has ONLY Run-Tracker.bat / Setup.bat / README.txt; the tracker
