...
CarnageReport sampleReport() {
    ...
    add("RingRunner117", 0, 113, 33, 18, 18, 0);
    add("BR55Enjoyer", 0, 85, 12, 14, 26, 0);
    add("Cortanas Ghost", 0, 32, 42, 19, 21, 0);
    add("NoScopeNed", 0, 20, 32, 17, 20, 0);
    add("TeaBagTactician", 1, 61, 15, 21, 32, 1);
    add("PlasmaPickle", 1, 49, 16, 16, 31, 1);
    add("GruntBirthday", 1, 42, 34, 19, 26, 1);
...
std::vector<BoardSection> sampleBoardSections() {
    ...
    const Row rows[] = {
        {"SgtForge Jr", 1247, 7, 3, 0, 0.94},  {"MasterChef117", 1230, 5, 4, 0, 1.22},
        {"GruntBirthday", 1217, 5, 3, 0, 1.10},   {"SplazerDazer", 1216, 1, 0, 0, 0.67},
        {"RingRunner117", 1214, 2, 1, 0, 1.08},      {"NoScopeNed", 1214, 5, 5, 0, 0.87},
        {"Hysterically", 1186, 5, 5, 0, 0.94}, {"Cortanas Ghost", 1184, 4, 4, 0, 1.11},
        {"CrouchNade", 1169, 0, 2, 0, 1.04},      {"TeleporterCamper", 1169, 3, 6, 0, 1.00},
...
std::vector<CsrBoardSection> sampleCsrBoardSections() {
    ...
    const Row rows[] = {
        {"SgtForge Jr", 26.4, 7, 3, 0, 1.34},  {"MasterChef117", 24.1, 5, 4, 0, 1.22},
        {"GruntBirthday", 22.0, 5, 3, 0, 1.10},   {"SplazerDazer", 20.6, 1, 0, 0, 1.67},
        {"RingRunner117", 19.2, 2, 1, 0, 1.08},      {"NoScopeNed", 17.5, 5, 5, 0, 0.87},
        {"Hysterically", 15.1, 5, 5, 0, 0.94}, {"Cortanas Ghost", 12.8, 4, 4, 0, 1.11},
        {"CrouchNade", 9.4, 0, 2, 0, 1.04},       {"TeleporterCamper", 6.0, 3, 6, 0, 1.00},
        {"FlagDropper88", 2.1, 3, 7, 0, 0.85},
    };
